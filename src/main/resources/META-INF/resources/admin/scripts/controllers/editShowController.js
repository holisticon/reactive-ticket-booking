...
angular.module('ticketmonster').controller('EditShowController', function($scope, $routeParams, $location, ShowResource , EventResource, PerformanceResource, VenueResource) {
    var self = this;
